...
public class CircuitClone {
	
	Circuit circuit;
	public CircuitClone(Circuit circ) {
		circuit = circ;
		appearance = circuit.getAppearance();
		staticAttrs = circuit.getStaticAttributes();
		subcircuitFactory = circuit.getSubcircuitFactory();
		locker = new CircuitLockerClone();
		...
		/*circuitsUsingThis = circuit.getCircuitsUsingThis();*/
	}
